      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-start">
          ...
          <div className="md:col-span-4 flex flex-col items-end gap-16">
            ...
            <button className="group flex items-center gap-6 border border-border-color px-8 py-4 rounded-full hover:border-accent-purple transition-all bg-background/50 overflow-hidden relative">
        ...
        <div className="mt-40 relative flex justify-center overflow-hidden pointer-events-none">
          <span className="text-foreground font-sans font-black text-[12vw] opacity-[0.03] uppercase leading-none whitespace-nowrap">
